...
class FestivalsControllerTest < ActionController::TestCase
  ...
  test "should create festival" do
    assert_difference('Festival.count') do
      post :create, festival: { edition: @festival.edition, end_date: @festival.end_date, name: @festival.name, start_date: @festival.start_date }
    end
  ...
  test "should update festival" do
    patch :update, id: @festival, festival: { edition: @festival.edition, end_date: @festival.end_date, name: @festival.name, start_date: @festival.start_date }
    assert_redirected_to festival_path(assigns(:festival))
  end
