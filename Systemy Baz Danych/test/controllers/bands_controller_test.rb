...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { about: @band.about, country: @band.country, formed_on: @band.formed_on, genre: @band.genre, name: @band.name }
    end
  ...
  test "should update band" do
    patch :update, id: @band, band: { about: @band.about, country: @band.country, formed_on: @band.formed_on, genre: @band.genre, name: @band.name }
    assert_redirected_to band_path(assigns(:band))
  end
